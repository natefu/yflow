...
# variables config
VAR_TICKET_ID: str = 'TICKET_ID'
VAR_TICKET_STATE: str = 'TICKET_STATE'
VAR_TICKET_PROCESS: str = 'TICKET_RPOCESS'
VAR_TICKET_APPLICANT: str = 'TICKET_APPLICANT'
VAR_TICKET_APPLICANT_NAME: str = 'TICKET_APPLICANT_NAME'
VAR_NODE_ID: str = 'NODE_ID'
VAR_NODE_STATE: str = 'NODE_STATE'
VAR_NODE_ISSUER: str = 'NODE_ISSUER'
VAR_NODE_ISSUER_NAME: str = 'NODE_ISSUER_NAME'
